      ...
      <div className="container-general">
        ...
        <div className="about-me-container-items">
          ...
          <p className="about-me-text">
            ...
            <span className="about-me-span">API manipulation</span>; use of
            tools like{" "}
            <span className="about-me-span">Postman and Webpack</span>;
            knowledge of frameworks and libraries such as{" "}
            <span className="about-me-span">React and Angular</span>;
            development of responsive interfaces with modern CSS{" "}
            <span className="about-me-span">
              (Bootstrap, Carbon Design, Material UI, Reveal Js and others)
            </span>{" "}
            and preprocessors like <span className="about-me-span">SASS</span>;
            programming in{" "}
            <span className="about-me-span">JavaScript ES6+</span>; unit and
            integration testing with <span className="about-me-span">Jest</span>
            ; version control with{" "}
            <span className="about-me-span">Git and GitHub</span>; optimization
            of web application{" "}
            <span className="about-me-span">
            ...
            <span className="about-me-span">agile development practices</span>{" "}
            and <span className="about-me-span">Scrum</span>;{" "}
            <span className="about-me-span">
            ...
            . This experience was fundamental to my professional growth,
            ...
            expected graduation in December 2024. <br /> I am{" "}
            <span className="about-me-span">
            ...
            gamer and previously managed a gaming-focused YouTube channel.
            There, I produced and edited videos, which helped me{" "}
            <span className="about-me-span">
